...
% col.Limits = [0 70.8197];
% col.Label.String = 'Depth of Surface Crevasses';
% col.TickLabels = {'0 m','10 m','20 m','30 m','40 m','50 m','60 m','70 m'};
% 
 geoshow([S([1,2,5,6,12,15,16,21,24]).Y],[S([1,2,5,6,12,15,16,21,24]).X]+180,...
     'Color','black','Linewidth',2)

for q = [1,2,5,6,12,15,16,21,24]%[3,8,11,15] %  selection of a the feature from the shape file
    ...
    for i = 1:END
        ...
        if i == END % End of the feature
            ...
            Max_opening_width = max(delta);
            Max_prop_rate = max(V_rate);

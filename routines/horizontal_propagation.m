...
% JPL, June 2017
%
% DISPLACEMENT APPROACH %%%%% UPDATE FOR PAPER TABLE RESULTS, Mattia, June 2018
...
for q = 1:26% [1,2,5,6,12,15,16,21,24] %  selection of a the feature from the shape file
...
%             DONE = strcat('->',num2str(S(q).Name),' completed in :',num2str(ceil(Cycles_to_build(q))),' cycles');
%             disp(DONE)
% 
%            
%             figure(1),hold on
%             geoshow([S(q).Y(1:5:END)],[S(q).X(1:5:END)]+180,...
%                 'Color','white','Linewidth',2)
%             
%             figure(2),hold on
%  
%             plot (TIME(1:end-2)./(24*3600),V_rate(1:end-2)./1000,'Linewidth',1)
%             
...
% %% PLOT SETTINGS
% figure(2),hold on
% set(figure(2),'Units','inches','Position',[0 0 4.5 4.5],'PaperPositionMode','auto')
% %  legend('Agenor Linea','Minos Linea','Cadmus Linea','Euphemus Linea','Harmonia Linea',...
% %    'Udaeus Linea','Mehen Linea')
% grid on
% legend('Minos Linea','Mehen Linea','Pelorus Linea','Tormsdale Linea')
% xlabel('Days after PeriJove','FontUnits','Points','Interpreter','Latex',...
%     'FontSize',12,'FontName','Times')
% ylabel('Propagation Rate [km/s]','FontUnits','Points','Interpreter','Latex',...
%     'FontSize',12,'FontName','Times')
...
% % print -dpdf Development_events_zoom
% % 
% % %%%%%% PAPER %%%%%%%%%
% % print -depsc2 Development_events_zoom
% 
% 
% figure(3),hold on
% set(figure(3),'Units','inches','Position',[0 0 4.5 4.5],'PaperPositionMode','auto')

Cycles_to_build_filtered = Cycles_to_build~=0;
Cycles_to_build_filtered = Cycles_to_build~=20;
% h = histogram (ceil(Cycles_to_build(Cycles_to_build~=0)));
% h.NumBins = q;
% 
% grid on
% xlabel('Number of Cycles to full Development','FontUnits','Points','Interpreter','Latex',...
%     'FontSize',12,'FontName','Times')
% ylabel('Number of Features','FontUnits','Points','Interpreter','Latex',...
%     'FontSize',12,'FontName','Times')
% set (gca,'Units','Normalized','FontUnits','Points','FontWeight','normal',...
%     'FontSize',11,'FontName','Times')
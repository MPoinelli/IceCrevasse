...
GROWTH_RATE_km_hr  = GROWTH_RATE.*(3.6);

T = table(MAX_PRO_RATE,MAX_OPE_RATE_mm_yr,TIME_TO_DEVE_days,STANDBY_PERI_days,GROWTH_RATE_km_hr,'RowNames',{'1','2','Delphi','Cilicia'})
%SAVE2PNG Saves a figure as a properly cropped png
%
%   save2png(fileName,handle,dpi)
%
%   - fileName: Destination to write the png to.
...
function save2png(fileName,handle,dpi)
